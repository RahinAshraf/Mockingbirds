...
class _TurnByTurnState extends State<TurnByTurn> {
  ...
  Future<void> _onRouteEvent(e) async {
    ...
    setState(() {
      //changeStuff();
      // if (startTime.AddMinutes(20) = currentTime){
      //   print("5 mins");
      // }
      if (startTime.compareTo(currentTime)== 5){

      }
    });

    /// every 5 min check if the stations has changed
    /// IF CHANGED CHANGE POINTS
    /// get location of user and check
    /// 
  }
