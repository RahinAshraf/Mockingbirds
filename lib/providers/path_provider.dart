///Commented and to be used on extension of the project
///
// import 'dart:convert';
...
/// A class that checks the paths between one to many points and sortss the docking stations. Useful for extention for the edit dock
