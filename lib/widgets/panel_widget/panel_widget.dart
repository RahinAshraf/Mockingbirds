...
// TODO: how do we deal with from and to!
                ...
                children: [
                  SizedBox(
                    child: TextField(
                      ...
                      onTap: () {
                        print(
                            "ONCHANGED getting isFrom on tapped textfield!!! $numberCyclists ");
                        widget.handleOnSearchClick(
                            context, controller, onAddressAdded);
                      },
                      onEditingComplete: () {
                        print("ONCHANGED");
                        print("ONCHANGED getting isFrom!!! $numberCyclists ");
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          onPressed: () {
                            print("SUE CURRENT LOCATION + ISFROM = TRUE");
